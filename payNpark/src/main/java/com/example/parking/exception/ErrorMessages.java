...
public class ErrorMessages {
	...
	static final String SLOTS_ALREADY_INITIALIZED = "Parking Slots already initialized, you can update it using update api";
	static final String INITILIZATION_DONE_BEFORE = "initilization already done";
}
